...
const FloatingNav: React.FC<FloatingNavProps> = ({ onHomeClick, onAddClick, onProfileClick }) => {
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50">
      <div className="dark:bg-black/20 bg-white/30 backdrop-blur-2xl px-4 py-3 rounded-full flex items-center gap-8 shadow-2xl dark:shadow-black/50 border dark:border-white/10 border-black/10">
        {/* Add Button */}
        <motion.button
